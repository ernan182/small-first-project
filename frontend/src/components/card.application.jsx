...
//
// this show the cards application 
//
function CardApplication({app}) {
    const {deleteApplication} = ApplicationContextU();
    return(
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-xl hover:bg-white/15 transition-all duration-300 transform hover:-translate-y-2 group">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/10">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-400">
                        ...
                        <span className="truncate max-w-32" title={app.link}>
